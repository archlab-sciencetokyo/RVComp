...
`define SSTATUS_READ_MASK           (`MSTATUS_SD_MASK | `SSTATUS_MXR_MASK | `SSTATUS_SUM_MASK | `MSTATUS_FS_MASK | `SSTATUS_SPP_MASK | `SSTATUS_SPIE_MASK | `SSTATUS_SIE_MASK)
`define SSTATUS_WRITE_MASK          (`SSTATUS_MXR_MASK | `SSTATUS_SUM_MASK | `MSTATUS_FS_MASK | `SSTATUS_SPP_MASK | `SSTATUS_SPIE_MASK | `SSTATUS_SIE_MASK)
...
`ifdef RVTEST_MOCK
`define MSTATUS_FS_MASK             'h00006000
`define MSTATUS_SD_MASK             'h80000000
`else
`define MSTATUS_FS_MASK             'h00000000
`define MSTATUS_SD_MASK             'h00000000
`endif
...
`define MSTATUS_WRITE_MASK          (`MSTATUS_TSR_MASK | `MSTATUS_TW_MASK | `MSTATUS_TVM_MASK | `MSTATUS_MXR_MASK | `MSTATUS_SUM_MASK | `MSTATUS_MPRV_MASK | `MSTATUS_FS_MASK | `MSTATUS_MPP_MASK | `MSTATUS_SPP_MASK | `MSTATUS_MPIE_MASK | `MSTATUS_SPIE_MASK | `MSTATUS_MIE_MASK | `MSTATUS_SIE_MASK)
