...
## Document
If you want to read the document, please visit the following link:
<!-- [RVComp Documentation](https://example.com) -->
...
Most of RVComp is distributed under the [MIT](https://opensource.org/licenses/MIT) license, so the project source code can be freely used, modified, and redistributed. The following components follow their respective licenses; see the LICENSE file for full details.

- **DRAM controller**: [Xilinx MIG](https://www.xilinx.com/products/design-tools/mig.html) (Xilinx End User License Agreement)
- **Clock generation**: Xilinx Clocking Wizard (Xilinx End User License Agreement)
- **prog/coremark**: [CoreMark-PRO](https://www.eembc.org/coremark-pro/) (EEMBC License + Apache License 2.0)
- **prog/embench**: [Embench-IoT](https://github.com/embench/embench-iot) (BSD License)
- **prog/riscv-tests**: [riscv-tests](https://github.com/riscv/riscv-tests) (MIT License)

- **OpenSBI**: [OpenSBI for customized for RVComp](https://github.com/archlab-sciencetokyo/opensbi.git) (BSD-2-Clause License)
...
This section explains how to run RVComp on an FPGA board using a prebuilt bitstream and Linux image. Please download the archive from the distribution location (<span style="color: red;">link TBA</span>).
